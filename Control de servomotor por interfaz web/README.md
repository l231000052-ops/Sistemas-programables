...
![Diagrama.jpg](Diagrama/Diagrama.png)
...
La realización de esta práctica permitió conocer una forma de controlar un servomotor utilizando una interfaz web. Las pruebas realizadas ayudaron a observar cómo una instrucción enviada desde la página puede generar una acción física en el servomotor. Además, la actividad permitió comprender mejor la relación entre el código, la comunicación inalámbrica y el funcionamiento de los componentes utilizados.
